...
const ConfirmRide = (props) => {
    return (
        <div>
            <div ref={props.confirmRideRef} className='fixed w-full  z-10 bg-white bottom-0 translate-y-full  px-3 py-6 pt-12'>
                <h5 onClick={
                    () => {
                ...
                <div className='flex flex-col gap=5 items-center justify-center'>
                    ...
                    <button onClick={()=>{props.setVehicleFound(true)}} className='w-full bg-green-500 text-white font-semibold p-2 rounded-lg mt-2'>Confirm</button>
                </div>
            </div>
        </div>
    )
